...
$txt = "Name: ". $form->get_name()."\n";
fwrite($myfile, $txt);


$txt = "Email: ". $form->get_email()."\n";
fwrite($myfile, $txt);


$txt = "Gender: ". $form->get_gender()."\n";
fwrite($myfile, $txt);
...
<?php
	...
	$child_node_title = $dom->createElement('name', $form->get_name());

		$movie_node->appendChild($child_node_title);

		$child_node_year = $dom->createElement('gmail', $form->get_email());

		$movie_node->appendChild($child_node_year);

	$child_node_genre = $dom->createElement('gender', $form->get_gender());
